========================================================================
    MICROSOFT 基础类库 : AF_WebServiceImpl 项目概况
========================================================================


应用程序向导已为您创建了此 AF_WebServiceImpl DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 AF_WebServiceImpl DLL
的每个文件的内容摘要。

AF_WebServiceImpl.vcproj
...
AF_WebServiceImpl.h
    这是 DLL 的主头文件。它声明了
    CAF_WebServiceImplApp 类。

AF_WebServiceImpl.cpp
    这是主 DLL 源文件。它包含了类 CAF_WebServiceImplApp。
AF_WebServiceImpl.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。
    它包含存储在 RES 子目录下的图标、位图和光标。
    此文件可在 Microsoft Visual C++ 中直接编辑。
    

res\AF_WebServiceImpl.rc2
    此文件包含不由 Microsoft 
    Visual C++ 编辑的资源。您应将不能由
    资源编辑器编辑的所有资源放置在此文件中。

AF_WebServiceImpl.def
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 AF_WebServiceImpl.pch
