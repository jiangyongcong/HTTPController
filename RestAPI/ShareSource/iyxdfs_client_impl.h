...
namespace nsDfs
{
	...
	{
		enMobileFile = 0, // 源文件，看数据节点配置文件决定
...
namespace nsLog
{
	...
	public:
		virtual void ShowWndLog(const int v_iWndLogType, const char v_szWndLog[]) = 0; // 日志输出
	};
}
...
public:
	C_Dfs_Client_CB(void):m_cbUpload(NULL),m_cbDownload(NULL),m_cbDownload_Web(NULL),m_dwObjId(-1)
	{
